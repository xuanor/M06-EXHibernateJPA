...
public class CiutatCiutadaTest {
    ...
    public void testCreateCiutat() {
        ...
        testCiutat = Manager.addCiutat("Ciutat de Prova", "País Prova", 100000);
    ...
    public void testListCiutadans() {
        // Provar llistar tots els ciutadans
    ...
    public void testRemoveCiutadaFromCiutat() {
        ...
        assertTrue(updatedCiutat.getCiutadans().contains(testCiutada2), "La ciutat encara hauria de contenir el ciutadà restant");
    }

    @Test
    @Order(7)
    public void testDeleteCiutadans() {
        // Eliminar ciutadans
